...
#圈x
[rewrite local]
^https:\/\/api3-normal-c-\w+\.snssdk\.com\/score_task\/v1\/task\/(sign_in|get_read_bonus) url script-request-header https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js
^https:\/\/api3-normal-c-\w+\.snssdk\.com\/ttgame\/game_farm\/home_info url script-request-header https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js
[task]
5,35 8-23 * * * https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js, tag=今日头条极速版, enabled=true

#loon
http-request ^https:\/\/api3-normal-c-\w+\.snssdk\.com\/score_task\/v1\/task\/(sign_in|get_read_bonus) script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js, requires-body=true, timeout=10, tag=今日头条极速版sign
http-request ^https:\/\/api3-normal-c-\w+\.snssdk\.com\/ttgame\/game_farm\/home_info script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js, requires-body=true, timeout=10, tag=今日头条极速版farm
cron "5,35 8-23 * * *" script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js, tag=今日头条极速版

#surge

jrttsign = type=http-request,pattern=^https:\/\/api3-normal-c-\w+\.snssdk\.com\/score_task\/v1\/task\/(sign_in|get_read_bonus),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js,script-update-interval=0
jrttfarm = type=http-request,pattern=^https:\/\/api3-normal-c-\w+\.snssdk\.com\/ttgame\/game_farm\/home_info,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js,script-update-interval=0
jrtt = type=cron,cronexp="5,35 8-23 * * *",wake-system=1,script-path=https://raw.githubusercontent.com/Wizardp007/Scripts/main/QuantumultX/jss/jrtt.js,script-update-interval=0
...
return new Promise((resolve, reject) => {
  let invitatonurl ={
    ...
    headers :JSON.parse(farmkey),
      timeout: 60000,
    body: JSON.stringify({"invitecode" : "1668302798"})
}
