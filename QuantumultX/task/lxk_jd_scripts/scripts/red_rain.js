...
[rewrite_local]
^https://api\.m\.jd\.com/client\.action\?functionId\=liveActivityV842 url script-request-body /data/data/com.termux/files/home/storage/shared/jd/scripts/get_red_rain.js
 */
const $ = new Env('红包雨');
